...
head() {
    return {
      ...
      meta: [
        ...
        { hid: 'keywords', name: 'keywords', content: ['Oke Michael','Mykelcodex','Mykeel','Michael Oke','Software Engineer in Nigeria','Software','Laravel Developer','Vuejs Developer','Open Source','Develop Community','PHP','Javascript'] },
        { hid: 'robots', name: 'robots', content: 'all' },
        { hid: 'twitter:card', name: 'twitter:card', content: 'summary_large_image' },
        { hid: 'title:title', name: 'twitter:title', content: 'Oke Michael - Software Engineer' },
