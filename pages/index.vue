...
head() {
    return {
      ...
      meta: [
        ...
        { name: 'keywords', content: ['Oke Michael','Mykelcodex','Mykeel','Michael Oke','Software Engineer in Nigeria','Software','Laravel Developer','Vuejs Developer','Open Source','Develop Community','PHP','Javascript'] },
